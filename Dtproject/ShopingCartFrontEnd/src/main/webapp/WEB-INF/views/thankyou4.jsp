  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="productList.jsp" style="color: #c19a6b ">BIKE SPARES AND SERVICES</p></a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="login.jsp" style="color: #c19a6b;"><span class="glyphicon glyphicon-user" class="text-danger"></span>Logout</a></li>
...
<h2> THANK YOU FOR SHOPPING  WITH US.. WE WILL KEEP YOU UPDATED!!</h2>
